<?php
/*
 * reporte_descarga.php — Endpoint GET del módulo Reportes
 * Descarga o previsualiza un PDF de reporte ya generado por su ID.
 * Acceso: admin y empleado (solo sus propios reportes). Parámetros: ?id=X [&preview=1].
 * Valida que el reporte pertenezca al usuario o a su empresa antes de servir el archivo.
 */
