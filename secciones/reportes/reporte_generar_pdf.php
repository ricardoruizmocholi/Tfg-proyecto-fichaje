<?php
/*
 * reporte_generar_pdf.php — Endpoint POST del módulo Reportes
 * Genera un informe mensual de fichajes y horarios en PDF usando la librería TCPDF.
 * Acceso: solo admin. Guarda el PDF en uploads/reportes_pdf/ y registra en REPORTES.
 * Devuelve JSON {success, message, url_pdf}.
 */
