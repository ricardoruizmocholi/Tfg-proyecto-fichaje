<?php
/*
 * reporte_excel.php — Endpoint GET del módulo Reportes
 * Genera y envía directamente (descarga) un Excel con los fichajes del empleado seleccionado.
 * Acceso: solo admin. Usa la librería PhpSpreadsheet.
 * Parámetros GET: id_usuario, mes, anio.
 */
