<?php
/*
 * tickets.php — Vista de tickets del empleado
 * Incluida por panel.php (seccion=tickets). Empleado y admin.
 * Permite crear nuevos tickets de soporte y ver el historial de los propios tickets.
 * Las acciones de creación y cambio de estado se hacen via secciones/api/ticket_*.php.
 */
