<?php
/*
 * vacaciones_cuadrante.php — Vista del cuadrante de vacaciones (admin)
 * Incluida por panel.php (seccion=horario&vista=vacaciones). Solo admin.
 * Muestra un calendario anual con las vacaciones aprobadas de todos los empleados.
 * Permite ver el resumen de días usados/restantes por empleado.
 */
