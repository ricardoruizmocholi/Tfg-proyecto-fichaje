<!--
  fichaje_ver.php — Vista del historial de fichajes
  Incluida por panel.php (admin: seccion=fichaje&vista=ver).
  El admin puede filtrar por empleado y rango de fechas.
  El empleado solo ve sus propios registros.
-->
