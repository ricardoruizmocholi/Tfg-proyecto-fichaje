<!--
  fichaje_modificar.php — Vista de modificación de fichajes (admin)
  Incluida por panel.php (seccion=fichaje&vista=modificar). Solo admin.
  Permite editar, añadir manualmente o eliminar registros de fichaje históricos.
  Soporta jornada partida (PARTIDA_M / PARTIDA_T).
  Hace fetch a: fichaje_modificar_guardar.php, fichaje_eliminar.php, fichaje_anadir.php.
-->
...
function guardarFichaje(idFichaje) {
    ...
    fetch('secciones/fichaje/fichaje_modificar_guardar.php', {
        method: 'POST',
...
function eliminarFichaje(idFichaje) {
    ...
    fetch('secciones/fichaje/fichaje_eliminar.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
...
function anadirFichaje(event) {
    ...
    fetch('secciones/fichaje/fichaje_anadir.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
        body: JSON.stringify(datos)
    })
