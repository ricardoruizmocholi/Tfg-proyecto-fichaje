/**
 * tipos_jornada_helper.js — Helper global de tipos de jornada
 * Cargado por panel.php en todas las páginas (script src global).
 * Obtiene los tipos de jornada custom activos de la empresa via fetch a
 * secciones/api/obtener_tipos_jornada.php y rellena todos los selectores
 * con clase .select-tipo-jornada presentes en el DOM.
 * Guard anti-doble-carga: evita redeclarar variables si se incluye más de una vez.
 */
