<?php
/*
 * cambiar_foto_perfil.php — Endpoint POST del módulo Perfil
 * Recibe un archivo de imagen (multipart), lo valida, lo guarda en secciones/uploads/
 * con el formato perfil_{id}_{timestamp}.{ext} y actualiza la columna foto_perfil del usuario.
 * Acceso: empleado y admin. Devuelve JSON {success, message, nueva_url}.
 */
