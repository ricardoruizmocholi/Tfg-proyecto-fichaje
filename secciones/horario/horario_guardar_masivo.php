<?php
/*
 * horario_guardar_masivo.php — Endpoint POST del módulo Horario
 * Guarda múltiples horarios de una vez para el empleado autenticado (envío mensual).
 * Acceso: empleado y admin. Llamado desde horario_calendario.js al hacer "Enviar a validar".
 * Devuelve JSON {success, message, insertados}.
 */
session_start();
