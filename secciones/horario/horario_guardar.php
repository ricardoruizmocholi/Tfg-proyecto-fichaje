<?php
/*
 * horario_guardar.php — Endpoint POST del módulo Horario
 * Guarda o actualiza un horario individual en la tabla HORARIOS.
 * Acceso: solo admin. Valida empresa y verifica tipos de jornada custom.
 * Devuelve JSON {success, message, id_horario}.
 */
