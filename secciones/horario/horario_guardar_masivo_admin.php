<?php
/*
 * horario_guardar_masivo_admin.php — Endpoint POST del módulo Horario
 * Guarda múltiples horarios de una vez en modo administrador.
 * Acceso: solo admin. Usado desde horario_cuadrantes_scripts.php y horario_admin_calendario.php.
